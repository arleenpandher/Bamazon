...
product1 = Product.create(title: "Harry Potter", description: "Flying lessons with the OG", service_id: 4, cost: 99.99, ratings: 0)
product1.photo.attach(io: open("https://herozon-dev.s3.ca-central-1.amazonaws.com/harry_potter.png"), filename:"harry_potter.png")

product2 = Product.create(title: "Bellatrix Lestrange", description: "Powerful and smart might kill you though", service_id: 4, cost: 2.99, ratings: 0)
...
product3 = Product.create(title: "Draco Malfoy", description: "Known enemy of Buckbeak, you might get killed", service_id: 4, cost: 8.99, ratings: 0)
product3.photo.attach(io: open("https://herozon-dev.s3.ca-central-1.amazonaws.com/draco_malfoy.png"), filename:"draco_malfoy.png")

product4 = Product.create(title: "Molly Weasley", description: "Might be able to help you fly, but will definitely feed you", service_id: 4, cost: 24.99, ratings: 0)
...
product5 = Product.create(title: "Severus Snape", description: "He will teach you but be prepared for his remarks", service_id: 4, cost: 59.99, ratings: 0)
...
product6 = Product.create(title: "Luna Lovegood", description: "She is very good with magical creatures but may get distracted", service_id: 4, cost: 79.99, ratings: 0)
...
product7 = Product.create(title: "Hermonie Granger", description: "She is an excellent teacher but be prepared she is strict", service_id: 4, cost: 99.98, ratings: 0)
...
product8 = Product.create(title: "Wormtail", description: "150% chance of betrayal is forecasted, good luck!", service_id: 4, cost: 0.01, ratings: 0)
